defmodule ShortsyWeb.Router do
  use ShortsyWeb, :router
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {ShortsyWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: ShortsyWeb.Telemetry
    end
  end
